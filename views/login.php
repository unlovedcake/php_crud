                    ...
                    <div class="card-body">
                        <form method="post">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo htmlspecialchars($username); ?>" id="username" name="username" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="password">Password:</label>
                                <input type="password" value="<?php echo htmlspecialchars($password); ?>" id="password" name="password" class="form-control">
